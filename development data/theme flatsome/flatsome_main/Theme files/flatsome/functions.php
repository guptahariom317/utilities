...
function flatsome_scripts() {
	...
	if(!isset($flatsome_opt['minified_flatsome']) || !$flatsome_opt['minified_flatsome']){
	   wp_enqueue_style( 'flatsome-icons', get_template_directory_uri() .'/css/fonts.css', array(), '2.01', 'all' );
	   wp_enqueue_style( 'flatsome-animations', get_template_directory_uri() .'/css/animations.css', array(), '2.01', 'all' );
	   wp_enqueue_style( 'flatsome-style', get_stylesheet_uri(), array(), '2.01', 'all');
	   wp_register_style('flatsome-effect', get_template_directory_uri() .'/css/effects.css', array(), '2.01', 'all' );
	} else {
	   wp_enqueue_style( 'flatsome-css-minified', get_template_directory_uri() .'/css/flatsome.min.css', array(), '2.01', 'all' );
	}	

	/* JS libaries */
	if(!isset($flatsome_opt['minified_flatsome']) || !$flatsome_opt['minified_flatsome']){
		wp_enqueue_script( 'flatsome-modernizer', get_template_directory_uri() .'/js/modernizr.js?v=2.01', array( 'jquery' ), '2.1.1', true );
 		wp_enqueue_script( 'flatsome-plugins', get_template_directory_uri() .'/js/plugins.js?v=2.01', array( 'jquery' ), '2.1.1', true );
		wp_enqueue_script( 'flatsome-iosslider', get_template_directory_uri() .'/js/jquery.iosslider.min.js?v=2.01', array( 'jquery' ), '2.1.1', true );
		wp_enqueue_script( 'flatsome-magnific-popup', get_template_directory_uri() .'/js/jquery.magnific-popup.js?v=2.01', array( 'jquery' ), '2.1.1', true );
		wp_enqueue_script( 'flatsome-theme-js', get_template_directory_uri() .'/js/theme.js?v=2.01', array( 'jquery' ), '2.1.1', true );
	} else {
		wp_enqueue_script( 'flatsome-theme-js-minified', get_template_directory_uri() .'/js/flatsome.min.js?v=2.01', array( 'jquery' ), '2.1.1', true );
	}
